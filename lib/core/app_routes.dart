      ...
      case app_path.lunch:
        ...
        return MaterialPageRoute(
          builder: (context) => MultiBlocProvider(providers: [
            BlocProvider(create: (context) => MealsCubit(sl.get<IMealsRepository>(), mealsCategoryName)),
            BlocProvider(create: (context) => DrinksCubit(sl.get<IDrinksRepository>(), drinksCategoryName))
          ], child: LunchScreen()),
        );
      default:
